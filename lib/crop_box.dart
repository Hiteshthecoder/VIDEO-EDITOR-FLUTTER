...
class _CropBoxState extends State<CropBox> with SingleTickerProviderStateMixin {
        ...
        Container(
          decoration: BoxDecoration(
            border: Border(
              ...
              right: BorderSide(width: widget.width - right, color: Colors.black38),
              bottom: BorderSide(width: widget.height - bottom, color: Colors.black38),
            ),
  ...
  void onStart(Offset details) {
    bool isTop = (details.dy < top + minDistance) && (details.dy > top - minDistance);
    bool isBottom = (details.dy < bottom + minDistance) && (details.dy > bottom - minDistance);
    bool isLeft = (details.dx < left + minDistance) && (details.dx > left - minDistance);
    bool isRight = (details.dx < right + minDistance) && (details.dx > right - minDistance);
    ...
    switch (select) {
      case 1:
        if (ratoi == null) {
          ...
          if (((t) >= minTop) && ((bottom - t) > minHeight) && ((right - l) > minWidth) && (l >= minLeft)) {
            setState(() {
              top = t;
              left = l;
            });
      ...
      case 2:
        if (ratoi == null) {
          ...
          double distance = delta.distance * cos(atan(-1 / ratoi) - delta.direction);
          double b = bottom - distance * cos(atan(ratoi));
          double l = distance * sin(atan(ratoi)) + left;
          if ((b <= maxBottom) && ((b - top) > minHeight) && ((right - l) > minWidth) && (l >= minLeft)) {
            setState(() {
              bottom = b;
              left = l;
            });
      ...
      case 3:
        if (ratoi == null) {
          ...
          if (((t) >= minTop) && ((bottom - t) > minHeight) && ((r - left) > minWidth) && (r <= maxRight)) {
            setState(() {
              top = t;
              right = r;
            });
      ...
      case 4:
        if (ratoi == null) {
          ...
          double r = distance * sin(atan(ratoi)) + right;
          if ((b <= maxBottom) && ((b - top) > minHeight) && ((r - left) > minWidth) && (r <= maxRight)) {
            setState(() {
              bottom = b;
              right = r;
            });
      ...
      case 5:
        if (ratoi == null) {
          ...
          if (((right - l) > minWidth) && (l >= minLeft) && ((b - t) >= minHeight)) {
            setState(() {
      ...
      case 6:
        if (ratoi == null) {
          ...
          double t = top - (delta.dx / ratoi) / 2;
          double b = bottom + (delta.dx / ratoi) / 2;
          if (((r - left) > minWidth) && (r <= maxRight) && ((b - t) >= minHeight)) {
            setState(() {
              if ((t >= minTop) && (b <= maxBottom)) {
                top = t;
                bottom = b;
      ...
      case 7:
        if (ratoi == null) {
          ...
          if (((bottom - t) > minWidth) && (t >= minTop) && ((r - l) >= minHeight)) {
            setState(() {
      ...
      case 8:
        if (ratoi == null) {
          ...
          double l = left - (delta.dy * ratoi) / 2;
          double r = right + (delta.dy * ratoi) / 2;
          if (((b - top) > minHeight) && (b <= maxBottom) && ((r - l) >= minHeight)) {
            setState(() {
              if ((l >= minLeft) && (r <= maxRight)) {
                left = l;
                right = r;
