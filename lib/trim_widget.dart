...
class TrimWidget extends StatefulWidget {
  ...
  const TrimWidget({Key? key, required this.controller, required this.editedInfo}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          TextButton(
            child: Text(Utils.formatTime(widget.editedInfo.start.inMilliseconds, true)),
            onPressed: () {
          ...
          TextButton(
            child: Text(Utils.formatTime(widget.editedInfo.end.inMilliseconds, true)),
            onPressed: () {
...
class TrimBox extends StatefulWidget {
  ...
  final double w;
  final EditedInfo editedInfo;
  const TrimBox({Key? key, required this.h, required this.w, required this.editedInfo}) : super(key: key);
...
class Thumbnails extends StatefulWidget {
  const Thumbnails({Key? key, required this.h, required this.w, required this.editedInfo}) : super(key: key);
  final double w, h;
  final EditedInfo editedInfo;
  @override
